...
These software packages are integral to the cloud workstation and batch scaling functionality.  The original list is on the [NMFS PAM-Cloud website](https://nmfs-ost.github.io/PAM-Cloud/content/Cloud.Processing.html).  
